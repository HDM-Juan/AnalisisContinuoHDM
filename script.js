document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- PESTAÑAS (Funciones de inicialización y actualización) ---

    function initializeServiciosTab() { /* ... similar a antes ... */ }
    function updateServiciosTab(data) { /* ... similar a antes ... */ }
    function initializeComprasTab() { /* ... similar a antes ... */ }
    function updateComprasTab(data) { /* ... similar a antes ... */ }
    function initializeAnticiposTab() { /* ... similar a antes ... */ }
    function updateAnticiposTab(data) { /* ... similar a antes ... */ }
    ...
    function handleTraceClick(event) {
        ...
        if (target.classList.contains('trace-link')) {
            ...
            alert(`Trazabilidad: Buscando Folio ${folio} en la pestaña ${tabId}. \n(Funcionalidad de filtro entre pestañas se implementará a continuación)`);
            // Lógica futura para filtrar la tabla de destino
            switchTab(tabId);
        }
    }

    // --- FUNCIONES UTILITARIAS ---
    // (Incluyo las versiones completas de las funciones que estaban resumidas antes)
